...
class RefreshTokenRequired(BooklyException):
    """User has provided a access token when an refresh token is needed"""

    pass


class UserAlreadyExist(BooklyException):
    """User has provided an email for a user who exists during signup"""

    pass


class InvalidCredentials(BooklyException):
    """User has provided incorrect credentials during login"""
